...
class IPluginRuntimeHost {
  public:
    ...
    virtual DownloadResult download(const std::string& pluginId, const std::string& url,
...
class IPlugin {
  public:
    ...
    virtual bool pack(const PluginCallContext& context, const std::string& projectPath, const std::string& outputPath,
    ...
    virtual std::optional<ProxyResolution> resolveProxyRequest(const PluginCallContext& context,
