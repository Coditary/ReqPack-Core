...
class LuaBridge : public IPlugin, public IPluginRuntimeHost {
  ...
  public:
    ...
    std::optional<PluginSecurityMetadata> getSecurityMetadata() const override {
        return m_securityMetadata;
    }
    ...
    std::optional<ProxyResolution> resolveProxyRequest(const PluginCallContext& context,
